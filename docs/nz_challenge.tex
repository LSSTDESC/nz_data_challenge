...
value for unassigned objects.  The files should be called, e.g., \texttt{nz\_challenge\_taskset\_1\_cardinal\_\_bhat\_1yr.hdf5}.
...
and trained models, and to implement the required functions.
...
For taskset 3, similar checks are performed on the file with the ensemble $n(z)$ samples.
