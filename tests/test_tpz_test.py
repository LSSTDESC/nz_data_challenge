...
from nz_data_challenge.tpz_test import (
    SUBMISSION_NAME,
    SUBMISSION_URL,
)
...
def test_example_submit_taskset_1(
    ...
    submit_utils.check_submission(SUBMIT_DIR, PUBLIC_AREA, ['taskset_1'])
...
def test_example_submit_taskset_2(
    ...
    """
    assert setup_submit_area == 0
    submit_utils.check_submission(SUBMIT_DIR, PUBLIC_AREA, ['taskset_2'])
...
#    """
#    assert setup_submit_area == 0
#    submit_utils.check_submission(SUBMIT_DIR, PUBLIC_AREA, ['taskset_3'])
...
def test_example_estimate_only_taskset_1(
    ...
    submit_utils.check_submission(test_submit_area, PUBLIC_AREA, ['taskset_1'])
...
def test_example_estimate_only_taskset_2(
    ...
    submit_utils.check_submission(test_submit_area, PUBLIC_AREA, ['taskset_2'])
...
#        'taskset_3',
#    )
#    submit_utils.check_submission(test_submit_area, PUBLIC_AREA, ['taskset_3'])
