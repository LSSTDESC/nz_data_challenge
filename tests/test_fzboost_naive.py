...
from nz_data_challenge.fzboost_naive import (
    SUBMISSION_NAME,
    SUBMISSION_URL,
)
...
def test_fzboost_naive_submit_taskset_1(
...
def test_fzboost_naive_submit_taskset_2(
    setup_submit_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_fzboost_naive_submit_taskset_3(
    setup_submit_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_fzboost_naive_estimate_only_taskset_1(
...
def test_fzboost_naive_estimate_only_taskset_2(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_fzboost_naive_estimate_only_taskset_3(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_fzboost_naive_train_and_estimate_taskset_1(
) -> None:
    """
    Test fuction to validate a submisson
    """
...
def test_fzboost_naive_train_and_estimate_taskset_2(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_fzboost_naive_train_and_estimate_taskset_3(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
