...
from nz_data_challenge.pontifex import (
    SUBMISSION_NAME,
    SUBMISSION_URL,
)
...
def test_pontifex_submit_taskset_1(
...
def test_pontifex_submit_taskset_2(
    setup_submit_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_pontifex_submit_taskset_3(
    setup_submit_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_pontifex_estimate_only_taskset_1(
...
def test_pontifex_estimate_only_taskset_2(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_pontifex_estimate_only_taskset_3(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_pontifex_train_and_estimate_taskset_1(
) -> None:
    """
    Test fuction to validate a submisson
    """
...
def test_pontifex_train_and_estimate_taskset_2(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
...
def test_pontifex_train_and_estimate_taskset_3(
    setup_model_area: int,
) -> None:
    """
    Test fuction to validate a submisson
