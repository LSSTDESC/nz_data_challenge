...
SUBMISSION_URL: str = "http://s3df.slac.stanford.edu/people/echarles/data_challenge/nz_estimates_example.tgz"
MODEL_URL: str = "http://s3df.slac.stanford.edu/people/echarles/data_challenge/nz_models_example.tgz"
...
def run_training(
    ...
    test_handle = TableHandle(f'input_{key}', path=ddf_file)            
...
def run_taskset_1_estimation_only(
    ...
    run_estimation(
        key, wfd_file, models_dir,  output_nz_estimate_file, output_bhat_file, output_nz_samples_file,
    )
