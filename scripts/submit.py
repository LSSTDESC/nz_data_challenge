...
if __name__ == '__main__':
    ...
    print(f"\n This script will help you submit your nz_data_challenge entry called {submission_name}\n")
    ...
    print(f"  https://github.com/LSSTDESC/nz_data_challenge/pull/new/submit/{submission_name}\n")
