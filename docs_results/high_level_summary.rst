...
.. list-table:: Image Gallery
   ...
   * - **Accuracy**
     - .. image:: results/accuracy.png
          ...
          :align: center
   * - **Balanced Accuracy**
     - .. image:: results/balanced_accuracy.png
          :width: 600px
          :align: center
   * - **Cohen's Kappa**
     - .. image:: results/cohens_kappa.png
          :width: 600px
          :align: center
   * - **Mutual Information**
     - .. image:: results/mutual_info.png
          :width: 600px
          :align: center
   * - **Log information loss**
     - .. image:: results/log_loss.png
          :width: 600px
          :align: center
   * - **Total Information Loss**
     - .. image:: results/total_information_loss.png
          :width: 600px
          :align: center
   * - **Delta Mean of bins added in quadrature**
     - .. image:: results/rms0_delta_mean.png
          :width: 600px
          :align: center
   * - **Delta RMS of bins added in quadrature**
